...
public class ClienteRestController {
	...
	public ResponseEntity<?> create(@Valid @RequestBody Cliente cliente, BindingResult result) {
		...
		response.put("mensaje", "Cliente añadido correctamente en la Base de Datos!");
	...
	public ResponseEntity<?> createUsuario(@Valid @RequestBody Usuario usuario, BindingResult result) {
		...
		if (Objects.isNull(userCheck)) {
			...
			response.put("mensaje", "Usuario añadido correctamente en la Base de Datos!");
	...
	public ResponseEntity<?> changePassword(@Valid @RequestBody ChangePassword passwords, @PathVariable String username,
		...
		if (Objects.isNull(usuarioActual)) {
			...
			System.out.println("Contraseñas:\n Antigua pass: "+passwords.getOldPassword()+"\n Nueva Pass: "+passwords.getNewPassword());
			
			
			if(!passwordEncoder.matches(passwords.getOldPassword(),usuarioActual.getPassword())) {
				System.out.println("USER-OldPassword: " + usuarioActual.getPassword());
				response.put("mensaje", "Error: no se pudo actualizar. Las contraseñas son iguales: ");
				return new ResponseEntity<Map<String, Object>>(response, HttpStatus.NOT_FOUND);
			}

		try {
			usuarioActual.setPassword(passwordEncoder.encode(passwords.getNewPassword()));
