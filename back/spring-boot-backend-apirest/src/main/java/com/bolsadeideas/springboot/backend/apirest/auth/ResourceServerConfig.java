...
public class ResourceServerConfig extends ResourceServerConfigurerAdapter {
	...
	public void configure(HttpSecurity http) throws Exception {
		http.authorizeRequests().antMatchers(HttpMethod.GET, "/api/clientes","/api/facturas/**",
				"/api/clientes/page/**",
				"/api/uploads/img/**",
				"/images/**",
				"/v3/api-docs/",
		...
		.antMatchers(HttpMethod.POST, "/api-docs.yaml","/swagger-ui/*","/api/facturas/**","/swagger-ui.html").permitAll()
